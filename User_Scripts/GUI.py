...
def running_output_page():
    ...
    pathToImage="C:/Users/moeez/Documents/repos/PeakPulse/User_Scripts/graph.png"
    ...
    with open("C:/Users/moeez/Documents/repos/PeakPulse/User_Scripts/data.txt", 'r') as file:
        data = file.read()
